...
export default {
  ...
  watch: {
    ...
    startingBills: {
      handler() { this.wallet.startingBills = this.startingBills * this.currency.rate },
      deep: true
    },
    endingBills: {
      handler() { this.wallet.endingBills = this.endingBills * this.currency.rate },
      deep: true
    },
  }
}
...
<template>
  <Dialog :visible="visible" modal header="Crear Nueva Cartera" :style="{ width: '20rem' }">
    ...
    <div class="flex col gap-0-5 center">
      ...
      <FloatLabel>
        <Calendar id="discountDate" v-model="discountDate" dateFormat="dd/mm/yy"/>
      ...
      <FloatLabel>
        ...
        <InputNumber id="startingBills" v-model="startingBills" mode="currency" :currency="currency.small"/>
      </FloatLabel>
      <FloatLabel>
        <label for="endingBills">Monto Final</label>
        <InputNumber id="endingBills" v-model="endingBills" mode="currency" :currency="currency.small"/>
      </FloatLabel>
